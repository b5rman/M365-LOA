...
| # | File | Description |
|---|------|-------------|
| 1 | **M365_LicenseOptimization_{ts}.csv** | Main per-user report: usage data, platform flags, intensity scores, capability levels, cost, recommendation text, pre-computed `Estimated Annual Savings (EUR)` and `Estimated Compliance Cost (EUR)` columns |
