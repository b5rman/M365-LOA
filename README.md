...
| 9 | **M365_OptimizationHeatmap_{ts}.html** | *(generated by M365-Heatmap.ps1)* Interactive HTML dashboard with up to 8 tabs: Overview tiles, Assessments by Category, Assessments by User, Assessments by SKU, License Groups, Workload Usage Matrix, Subscription Alerts (conditional), Copilot Adoption (conditional) |
