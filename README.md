...
generates per-user recommendations.
...
| 9 | **M365_OptimizationHeatmap_{ts}.html** | *(generated by Get-M365LicenseHeatmap.ps1)* Interactive HTML dashboard with up to 8 tabs: Overview tiles, Assessments by Category, Assessments by User, Assessments by SKU, License Groups, Workload Usage Matrix, Subscription Alerts (conditional), Copilot Adoption (conditional) |
| 10 | **M365_AssessmentReport_{ts}.docx** | *(generated by New-M365AssessmentReport.ps1)* Branded Word assessment report with executive financial summary, tiered findings, compliance cost callout, and disclaimers |
| 11 | **M365_LicenseAssessment_{ts}.xlsx** | *(generated by New-M365SummaryXLS.ps1)* Customer-facing Excel workbook — post-processed copy with assessment language, category coloring, rebuilt tabs by primary category, and zero-cost/informational rows removed from summary |
...
```
Get-M365LicenseOptimizationReport.ps1    # Main audit script (~8400 lines)
Get-M365LicenseHeatmap.ps1               # Interactive HTML dashboard generator
New-M365AssessmentReport.ps1             # Word assessment report generator (calls generate-report.js)
generate-report.js                       # Node.js docx builder (requires: npm install docx)
New-M365SummaryXLS.ps1                   # XLSX post-processor (customer-facing copy)
