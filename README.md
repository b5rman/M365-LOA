...
### Optimization Checks (148 Scenarios)
...
The script generates up to 9 files with a timestamp suffix:
...
| 9 | **M365_LicenseHeatmap_{ts}.html** | *(generated by Get-M365LicenseHeatmap.ps1)* Interactive HTML dashboard with 6 tabs: Overview tiles, Savings by Category, Savings by User, Savings by SKU, Over/Under-Licensed, License Groups |
...
Get-M365LicenseHeatmap.ps1               # Interactive HTML dashboard generator (v2.0)
